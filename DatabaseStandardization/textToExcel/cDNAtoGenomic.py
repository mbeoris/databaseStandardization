...
'''tests
resultList = get_key_from_value(brcaOne, 172)
print cDNA_to_genomic(resultList, -1)

resultList2 = get_key_from_value(brcaOne, 249)
print cDNA_to_genomic(resultList2, -1)

resultList3 = get_key_from_value(brcaOne, 300)
print cDNA_to_genomic(resultList3, -1)
'''